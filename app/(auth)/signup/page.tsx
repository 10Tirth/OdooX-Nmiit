        ...
        <div className="hidden lg:block">
          <div className="relative">
            <Image
              ...
              alt="EcoFinds signup illustration"
              width={600}
              height={800}
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <h2 className="text-2xl font-bold mb-2">Join the sustainable fashion revolution</h2>
              <p className="text-lg opacity-90">
                Discover pre-loved treasures and give your items a second life
              </p>
            </div>
          </div>
        </div>
